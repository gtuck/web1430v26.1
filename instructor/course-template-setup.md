...
- **Published template:** `https://github.com/web1430-fall26/course-template` (PUBLISHED Aug 22, 2026). The repo name does NOT need to match the task name: the crsapps faculty config maps the task to the repo — `"tasks": [{ "task": "CourseTemplate", "templateRepo": "web1430-fall26/course-template" }]` under course `WEB1430`. If the repo is ever renamed, update that mapping.
...
## First-time publish (done Aug 22, 2026 — kept for reference)
...
cp -R ~/Documents/GitHub/web1430-26.1/course-template ~/Documents/GitHub/course-template
cd ~/Documents/GitHub/course-template
...
# With GitHub CLI:
gh repo create web1430-fall26/course-template --private --source . --push
# ...or create an empty repo named course-template in the web1430-fall26 org on
# github.com, then:
#   git remote add origin https://github.com/web1430-fall26/course-template.git
...
```bash
rsync -av --delete --exclude .git ~/Documents/GitHub/web1430-26.1/course-template/ ~/Documents/GitHub/course-template/
cd ~/Documents/GitHub/course-template
