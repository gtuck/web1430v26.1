...
## Weekly focus
Getting every student to the same starting line: tools installed, accounts connected, Zoom working, and the weekly rhythm understood before a single line of code is written.

## Why this matters
In a virtual course, the toolchain *is* the classroom: class meets live over Zoom, and everything you build, submit, and get feedback on flows through your editor, terminal, and GitHub account. If those are not working together from day one, every subsequent lab becomes a debugging session about setup rather than about web development. This week removes that friction so the rest of the semester can move quickly. The habits you build now — showing up to sessions prepared, committing early, reading Canvas announcements, checking due dates on Sunday — compound over 16 weeks.
...
- Join a Zoom session with working audio, and share your screen for debugging help
- Describe the weekly rhythm: when class meets, when labs are due, and how to get help in session, in office hours, or on the discussion board
- Submit the Welcome Survey and the GitHub Repo Setup deliverable

## Core concepts

### How this course is structured
WEB 1430 runs on a Monday–Sunday weekly cycle anchored by two live Zoom sessions. Each week contains:
- **Monday session (9:30–10:45 AM)** — the week's core concepts and a live demo
- **Wednesday session (9:30–10:45 AM)** — guided lab/studio work, code review, and Q&A
- **Lecture notes** (this document and others like it) — your written reference for the same material
...
4. Virtual office hours run Monday and Wednesday, 8:00–9:00 AM and 12:30–2:00 PM, by appointment (the booking link is in the syllabus), in the same Zoom room.
...
### Getting help
Your fastest help channels are live: bring blockers to the Wednesday session or book an office-hours appointment. Between sessions, this course has a **Help & Questions** discussion board in Canvas. Post there before emailing. Include:
